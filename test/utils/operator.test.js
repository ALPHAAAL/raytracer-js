...
test('Test addition - tuple', (t) => {
    ...
    const result = Operators.add(tuple1)(tuple2)();
...
test('Test addition - color', (t) => {
    ...
    const result = Operators.add(color1)(color2)();
...
test('Test subtraction - point minus point', (t) => {
    ...
    const result = Operators.subtract(p1, p2);
...
test('Test subtraction - color', (t) => {
    ...
    const result = Operators.subtract(c1, c2);
...
test('Test negation', (t) => {
    ...
    const result = Operators.negate(t1);
...
test('Test scalar multiplication', (t) => {
    const t1 = new Tuple(1, -2, 3, -4);
    const result = Operators.multiply(t1, 3.5);
...
test('Test scalar multiplication - color', (t) => {
    ...
    const result = Operators.multiply(c1, 2);
...
test('Test scalar multiplication - division', (t) => {
    const t1 = new Tuple(1, -2, 3, -4);
    const result = Operators.multiply(t1, 0.5);
...
test('Test magnitude - Vector(1,0,0)', (t) => {
    ...
    const result = Operators.magnitude(v1);
...
test('Test normalization - Vector(4,0,0)', (t) => {
    ...
    const result = Operators.normalize(v1);
...
test('Test dot product', (t) => {
    ...
    const result = Operators.dotProduct(v1, v2);
...
test('Test cross product - a cross b', (t) => {
    const v1 = new Vector(1, 2, 3);
    const v2 = new Vector(2, 3, 4);
    const result = Operators.crossProduct(v1, v2);
...
test('Test hadamard product', (t) => {
    ...
    const result = Operators.hadamardProduct(c1, c2);
